...
def load_data(messages_filepath, categories_filepath):
    messages = pd.read_csv('D:\ResQ\DisasterResponseWorking_PhaseI-master\data\disaster_messages.csv')
    categories = pd.read_csv('D:\ResQ\DisasterResponseWorking_PhaseI-master\data\disaster_categories.csv')
    #merge datasets
